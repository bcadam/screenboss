...
gulp.task('styles',function(cb) {
  ...
  return gulp.src(app + 'stylus/*.{css,styl}')
    .pipe($.stylus({
...
gulp.task('watch', function() {
  gulp.watch(app + 'stylus/*.{css,styl}', ['styles']);
...
gulp.task('javascriptsdown', ['clean'], function() {
  return gulp.src(app + 'js/AdminLTE/*')
    .pipe(gulp.dest(dist + 'js/AdminLTE/'));
});

gulp.task('javascriptsdowntarget', ['clean'], function() {
  return gulp.src(app + 'js/AdminLTE/*')
...
gulp.task('bootstrap', ['clean'], function() {
  return gulp.src(app + 'js/bootstrap.min.js')
    .pipe(gulp.dest(dist + 'js/plugins/bootstrap.min.js'));
});
...
gulp.task('adminjs', ['clean'], function() {
  return gulp.src(app + 'js/AdminLTE/*.js')
    .pipe(gulp.dest(dist + 'js/AdminLTE/'));
});
...
gulp.task('images2', ['clean'], function() {
...
gulp.task('bo', ['clean'], function() {
  return gulp.src(app + 'js/plugins/bootstrap.min.js')
    .pipe(gulp.dest(dist + 'js/plugins/bootstrap.min.js'));
});
